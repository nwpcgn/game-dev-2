...
<section {...$$restProps}>
	...
	<Card>
		...
		<CardFooter>
			<button
				...
				class="btn {$_game.catcost >= $_game.money
					? 'btn-gray opacity-50'
					: 'btn-blue'}"
				disabled={$_game.catcost > $_game.money}>Upgrade</button>
			<span slot="red">
	...
	<Card>
		...
		<CardFooter>
			...
			class="btn {$_game.workercost >= $_game.money
				? 'btn-gray opacity-50'
				: 'btn-blue'}"
			disabled={$_game.workercost > $_game.money}>Upgrade</button>
			<span slot="red">
