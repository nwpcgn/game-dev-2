...
export default defineConfig({
	...
	shortcuts: {
		'btn': 'active:shadow-lg duration-200 ease-linear focus:outline-none outline-none shadow transition-all px-4 py-2 rounded font-semibold text-base cursor-pointer',
